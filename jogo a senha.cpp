...
int main() {
    ...
    while (true) {
        ...
        while (tentativas < max_tentativas && !acertou) {
            ...
            // Verifica dígitos corretos (independentemente da posição)
            if (tentativa1 == senha1 || tentativa1 == senha2 || tentativa1 == senha3 || tentativa1 == senha4 || tentativa1 == senha5) digitos_corretos++;
            if (num_digitos >= 2 && (tentativa2 == senha1 || tentativa2 == senha2 || tentativa2 == senha3 || tentativa2 == senha4 || tentativa2 == senha5)) digitos_corretos++;
            if (num_digitos >= 3 && (tentativa3 == senha1 || tentativa3 == senha2 || tentativa3 == senha3 || tentativa3 == senha4 || tentativa3 == senha5)) digitos_corretos++;
            if (num_digitos >= 4 && (tentativa4 == senha1 || tentativa4 == senha2 || tentativa4 == senha3 || tentativa4 == senha4 || tentativa4 == senha5)) digitos_corretos++;
            if (num_digitos == 5 && (tentativa5 == senha1 || tentativa5 == senha2 || tentativa5 == senha3 || tentativa5 == senha4 || tentativa5 == senha5)) digitos_corretos++;
            ...
            if ((num_digitos == 3 && tentativa1 == senha1 && tentativa2 == senha2 && tentativa3 == senha3) ||
                ...
                cout << "Números corretos: " << digitos_corretos << "\n";
            }
        }
        ...
        if (tentativas < max_tentativas && !acertou) {
            ...
            system("clear");
            cout << "Você não conseguiu adivinhar a senha em " << max_tentativas << " tentativas.\n";
